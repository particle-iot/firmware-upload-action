...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.run = exports.uploadFirmware = void 0;
...
function validVersion(firmwareVersion) {
...
function uploadFirmware(params) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const headers = Object.assign(Object.assign({}, form.getHeaders()), { authorization: `Bearer ${accessToken}`, accept: 'application/json', 'user-agent': 'particle-firmware-upload-action', 'x-particle-tool': 'particle-firmware-upload-action', 'x-api-version': '1.2.0' });
        ...
        try {
            ...
            if (error instanceof got_1.default.HTTPError) {
                throw new Error(`Error uploading firmware: ${error.response.body} (status code ${error.response.statusCode})`);
            }
            else {
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            core.info(`Uploading firmware ${firmwarePath} to product ${product} with version ${firmwareVersion}`);
            const { title: uploadedTitle, uploaded_by } = yield uploadFirmware({
                accessToken,
                firmwarePath,
                firmwareVersion,
                product,
            ...
            core.info(`Firmware uploaded successfully. \nTitle: ${uploadedTitle} \nUploaded by: ${uploaded_by}`);
        }
        catch (error) {
